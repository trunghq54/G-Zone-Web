    ...
    <div className="w-full bg-carbon">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-black h-[500px] md:h-[600px]">
            ...
            <div className="relative z-20 flex h-full flex-col justify-end px-6 py-12 md:w-2/3 lg:w-1/2 lg:px-12">
              ...
              <p className="mb-8 max-w-md text-lg text-gray-300">
                Precision-engineered protective gear designed for the modern
                rider. Experience speed without compromise.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/shop"
                  className="inline-flex h-12 items-center justify-center rounded-lg bg-primary px-8 text-base font-bold tracking-wide text-white transition-all hover:bg-primary-hover hover:shadow-[0_0_20px_rgba(230,0,0,0.4)]"
                >
                  SHOP COLLECTION
                </Link>
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-end justify-between">
          ...
          <Link
            to="/shop"
            className="hidden text-sm font-bold text-primary hover:text-white sm:block"
          >
            VIEW ALL CATEGORIES -&gt;
          </Link>
        </div>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2 h-auto md:h-[600px]">
          ...
          <Link
            to="/shop"
            className="group relative col-span-1 md:col-span-2 md:row-span-2 overflow-hidden rounded-xl bg-surface-dark border border-surface-border"
          >
            ...
            <div className="absolute bottom-0 left-0 z-20 p-8">
              ...
              <h3 className="text-4xl font-black uppercase text-white group-hover:text-primary transition-colors">
                Helmets
              </h3>
              <p className="mt-2 text-gray-400">
                DOT & SNELL certified for maximum safety.
              </p>
            </div>
          </Link>
          ...
          <Link
            to="/shop"
            className="group relative col-span-1 overflow-hidden rounded-xl bg-surface-dark border border-surface-border"
          >
